...
namespace RngLib
{
    ...
    public class SimpleRNG : IRng
    {
        ...
        void IRng.SetSeed(ulong Seed)
        {
            SetSeed((uint)(Seed >> 32), (uint)(Seed & 0xffffffffUL));
        }

        void IRng.UseDefaultSeed()
        {
        ...
        byte IRng.NextByte()
        {
            return (byte)(GetUint() & 0xff);
        }

        int IRng.Next(int Low, int High)
        {
            return Low + (int)(GetUniform() * (High - Low));
        }

        double IRng.NextDouble()
        {
            return GetUniform();
        }

        ulong IRng.NextULong()
        {
